          ...
          <thead className={`bg-gray-200 ${isScheduleTableHidden ? 'table-header-hidden' : ''}`}>
             ...
             {!isScheduleTableHidden && (
                 <tr>
                    ...
                    <th style={{width: "250px", minWidth: "250px"}} className="px-2 py-1 text-left border border-gray-300" data-en="Total Shifts / Hours" data-es="Total Turnos / Horas">Total Shifts / Hours</th> {/* Reduced width by half */}
            ...
            {employees.map((employee, index) => {
              ...
              return (
                <tr key={employee.uniqueId} className="border-b border-gray-300 align-top"> {/* Added align-top */}
                  ...
                  <td style={{width: "250px", minWidth: "250px"}} className="px-2 py-1 border border-gray-300">
